...
import { ArrowLeft, Mail, Phone, User, X, Clock, LogOut } from "lucide-react"
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3 flex-1">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-500">{user?.displayName || "Guest User"}</p>
            </div>
            {user && (
              <Button
                variant="outline"
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-6">
        <div className="max-w-2xl mx-auto space-y-6">
          {/* Contact Information */}
            ...
            <p className="text-xs text-gray-500 mt-2">Email cannot be changed. Contact support if you need assistance.</p>
          </div>
