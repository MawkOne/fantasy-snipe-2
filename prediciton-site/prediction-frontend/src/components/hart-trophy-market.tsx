...
const players = [
  { name: "Connor McDavid", team: "EDM", abbr: "CM", probability: 45, color: "bg-orange-600" },
  { name: "Nathan MacKinnon", team: "COL", abbr: "NM", probability: 25, color: "bg-blue-600" },
  { name: "Auston Matthews", team: "TOR", abbr: "AM", probability: 15, color: "bg-blue-500" },
  { name: "Nikita Kucherov", team: "TBL", abbr: "NK", probability: 8, color: "bg-blue-700" },
  { name: "Leon Draisaitl", team: "EDM", abbr: "LD", probability: 5, color: "bg-orange-600" },
  { name: "Cale Makar", team: "COL", abbr: "CM", probability: 2, color: "bg-blue-600" },
]

export function HartTrophyMarket() {
  return (
    <section>
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-2xl font-bold text-balance">Hart Trophy (MVP)</h2>
