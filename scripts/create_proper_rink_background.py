#!/usr/bin/env python3
"""
Create a proper NHL rink background following the exact layout from the images
Net at the top, only showing from blueline inward
"""
...
def create_proper_rink_background():
    """
    Create rink background with net at top, blueline inward only
    Following the exact zone layout from the images
    """
    ...
    ax.set_ylim(-43, 43)
    ax.set_aspect('equal')
    ax.set_xlabel('X Coordinate (Blueline to Goal Line)')
    ax.set_ylabel('Y Coordinate (Sideboard to Sideboard)')
    ax.set_title('NHL Offensive Zone - Net at Top\\nClean version for shot mapping')
...
def create_simple_offensive_zone():
    """
    Create a simple offensive zone background
    """
    fig, ax = plt.subplots(1, 1, figsize=(14, 18))
    ...
    ax.set_xlabel('X Coordinate (Blueline to Goal Line)')
    ax.set_ylabel('Y Coordinate (Sideboard to Sideboard)')
    ax.set_title('NHL Offensive Zone - Simple Version\\nNet at top, blueline inward only')
    ax.grid(True, alpha=0.3)
...
def main():
    """
    Main function to create proper rink backgrounds
    """
    print("Creating Proper NHL Rink Backgrounds")
    print("Net at top, only showing from blueline inward")
    print("="*50)
    
    print("\\n1. Creating detailed offensive zone with zones...")
    create_proper_rink_background()
    
    print("\\n2. Creating simple offensive zone...")
    create_simple_offensive_zone()
    
    print("\\nProper rink backgrounds created successfully!")
    print("These show the offensive zone with net at the top, following the exact layout.")
