#!/usr/bin/env python3
"""
Create NHL rink background with X displayed horizontally and Y displayed vertically
...
def create_horizontal_rink_background():
    """
    Create rink background with X horizontal, Y vertical
    ...
    # Set up the plot with X horizontal, Y vertical
    ax.set_xlim(75, 89)
    ax.set_ylim(-43, 43)
    ax.set_aspect('equal')
    ax.set_xlabel('X Coordinate (Blueline to Goal Line) - Horizontal')
    ax.set_ylabel('Y Coordinate (Sideboard to Sideboard) - Vertical')
    ax.set_title('NHL Offensive Zone - X Horizontal, Y Vertical\\nNet at right, blueline at left')
...
def create_simple_horizontal_offensive_zone():
    """
    Create a simple offensive zone background with X horizontal, Y vertical
    """
    fig, ax = plt.subplots(1, 1, figsize=(18, 14))
...
def main():
    """
    Main function to create horizontal rink backgrounds
    """
    print("Creating NHL Rink Backgrounds - X Horizontal, Y Vertical")
    print("Net at right, blueline at left")
    print("="*60)
    
    print("\\n1. Creating detailed offensive zone with zones...")
    create_horizontal_rink_background()
    
    print("\\n2. Creating simple offensive zone...")
    create_simple_horizontal_offensive_zone()
    
    print("\\nHorizontal rink backgrounds created successfully!")
    print("X is now displayed horizontally, Y is displayed vertically.")
