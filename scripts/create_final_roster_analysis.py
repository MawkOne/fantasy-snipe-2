...
def create_final_roster_analysis():
    """Create final roster analysis with proper deduplication"""
    
    client = bigquery.Client()
    
    print("="*80)
    print("CREATING FINAL ROSTER ANALYSIS WITH DEDUPLICATION")
    print("="*80)
    
    # Get comprehensive player analysis with deduplication
    comprehensive_query = """
    ...
    # Get detailed player breakdown by team with deduplication
    ...
    print("✅ Created final roster analysis with deduplication!")
    ...
    # Show some key teams
    print("\nKey Teams:")
    for _, team in team_results.head(10).iterrows():
        print(f"{team['team_abbr']}: {team['elite_players']} elite, {team['near_elite_players']} near elite, {team['breakout_candidates']} breakout, {team['corrected_strength']} strength - {team['contention_cycle']}")

if __name__ == "__main__":
    create_final_roster_analysis()
